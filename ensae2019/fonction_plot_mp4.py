...
def plot_geo_time_value_mp4(x, y, year, value, fig= None, axs=None, hue='', **kwargs):
    ...
    :param coord: Le système de coordonnées dans lequel sont enregistrés les données ()
    :param fig: figure
    ...
    :param style: le format du graph (mosaïque, gif, mp4, etc.) (string); valeurs possibles : mosaic, gif, mp4

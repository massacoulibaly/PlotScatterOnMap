...
class TestPlotGeoTimeValue(unittest.TestCase):
    def test_type_years(self):
        ...
        self.assertRaises(TypeError, plot_geo_time_value_gif, x, y, True, value,axs, hue='Test')
        self.assertRaises(TypeError, plot_geo_time_value_gif,x, y, "years", value,axs,hue='Test')
        self.assertRaises(TypeError, plot_geo_time_value_gif, x, y, 1, value,axs,hue='Test')
        
    def test_valeur_values(self):
        #On s'assure qu'une ValueError est envoyé quand c'est nécessaire
        #self.assertRaises(ValueError, plot_geo_time_value_gif, x, y, years, -1,axs, name, hue='Test')
        self.assertRaises(ValueError, plot_geo_time_value_gif, x, y, years, value_1,axs, hue='Test')

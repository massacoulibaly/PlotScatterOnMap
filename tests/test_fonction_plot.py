...
class TestPlotGeoTimeValue(unittest.TestCase):
    def test_type_years(self):
        ...
        self.assertRaises(TypeError, plot_geo_time_value, x, y, True, value,"PlateCarree",axs, hue='Test')
        self.assertRaises(TypeError, plot_geo_time_value,x, y, "years", value,"PlateCarree",axs, hue='Test')
        self.assertRaises(TypeError, plot_geo_time_value, x, y, 1, value,"PlateCarree",axs, hue='Test')
        
    def test_valeur_values(self):
        #On s'assure qu'une ValueError est envoyé quand c'est nécessaire
        self.assertRaises(ValueError, plot_geo_time_value, x, y, years, -1,"PlateCarree",axs, hue='Test')
        self.assertRaises(ValueError, plot_geo_time_value, x, y, years, [-1,1,4], "PlateCarree",axs, hue='Test')
        self.assertRaises(ValueError, plot_geo_time_value, x, y, years, [-1,-1,-4],"PlateCarree",axs, hue='Test')
